...
const db = mysql.createPool({ 
    host: process.env.DB_HOST || 'mysql.railway.internal',                //'localhost',
    user: process.env.DB_USER || 'root',                                          //'root',
    password: process.env.DB_PASS || 'NynVqUEThdZgHPbyRQwcXWYSQcPcCSdW',                         // '6432',
    database: process.env.DB_NAME || 'railway',                                //'crypto_tracker',
